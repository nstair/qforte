...
for sqop in sd_pool.terms():
    ...
    for ii in range(counta):
        for jj in range(countb):
            vis[sa[ii], sb[jj]] = counta * ii + jj + 1
            vis[ta[ii], tb[jj]] = counta * ii + jj + 1
...
# # Example usage:
# fig, ax = plot_vis_matrix(vis, gmu_info_str=g_mu_info_str, filename=None)
# plt.show()
