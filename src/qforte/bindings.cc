...
PYBIND11_MODULE(qforte, m) {
    ...
    py::class_<QubitOperator>(m, "QubitOperator")
        ...
        .def("get_l1_norm_sq", &QubitOperator::get_l1_norm_sq)
    ...
    py::class_<FCIComputer>(m, "FCIComputer")
        ...
        .def("get_element", &FCIComputer::get_element)
    ...
    py::class_<Tensor>(m, "Tensor")
        ...
        .def("sample_index_by_weight_normal", &Tensor::sample_index_by_weight_normal)
