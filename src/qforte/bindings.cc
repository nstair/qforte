...
// Force Thrust to use the host (CPP) backend in this translation unit.
// This prevents CUB / device intrinsics from being pulled in by mistake.
...
PYBIND11_MODULE(qforte, m) {
    ...
    py::class_<FCIComputer>(m, "FCIComputer")
        ...
        .def("evolve_pool_trotter", &FCIComputer::evolve_pool_trotter_v2, // Making Faster Version the Default! Check QK and PQE! 
            py::arg("sqop"),
            py::arg("evolution_time"),
            py::arg("trotter_steps"),
            py::arg("trotter_order"),
        ...
        .def("evolve_pool_trotter_not_inplace", &FCIComputer::evolve_pool_trotter, 
            py::arg("sqop"),
            py::arg("evolution_time"),
            py::arg("trotter_steps"),
            py::arg("trotter_order"),
    ...
    py::class_<FCIComputerThrust>(m, "FCIComputerThrust")
        ...
        .def("evolve_pool_trotter_gpu_v3", &FCIComputerThrust::evolve_pool_trotter_gpu_v3, 
            py::arg("sqop"),
            py::arg("evolution_time"),
            py::arg("trotter_steps"),
            py::arg("trotter_order"),
        ...
        .def("evolve_pool_trotter_gpu_v4", &FCIComputerThrust::evolve_pool_trotter_gpu_v4, 
            py::arg("sqop"),
            py::arg("evolution_time"),
            py::arg("trotter_steps"),
            py::arg("trotter_order"),
        ...
        .def("evolve_pool_trotter_gpu_v5", &FCIComputerThrust::evolve_pool_trotter_gpu_v5, 
            py::arg("sqop"),
            py::arg("evolution_time"),
            py::arg("trotter_steps"),
            py::arg("trotter_order"),
