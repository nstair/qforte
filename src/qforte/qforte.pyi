...
class FCIComputerThrust:
    ...
    def apply_sqop_evolution_cpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def evolve_pool_trotter_basic_cpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def evolve_pool_trotter_cpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_state(self) -> Tensor: ...
    def get_state_deep(self) -> Tensor: ...
