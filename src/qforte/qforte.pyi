...
class SQOperator:
    ...
    def count_pauli_terms_ex_deex(self, *args: Any, **kwargs: Any) -> Any: ...
    def count_unique_pauli_products(self, *args: Any, **kwargs: Any) -> Any: ...
    def count_cnot_for_exponential(self, *args: Any, **kwargs: Any) -> Any: ...
    def count_cnot_for_exponential_full(self, *args: Any, **kwargs: Any) -> Any: ...
    def count_cnot_for_jw_exponential(self, *args: Any, **kwargs: Any) -> Any: ...
    def count_T_for_exponential_full(self, *args: Any, **kwargs: Any) -> Any: ...
    def str(self) -> str: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...

class DFHamiltonian:
    """Python binding for DFHamiltonian."""
    def __init__(self) -> None: ...
    def set_trotter_first_leaf_basis_chage(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_nleaves(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_ff_eigenvalues(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_one_body_squares(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_one_body_ints(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_one_body_correction(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_scaled_density_density_matrices(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_basis_change_matrices(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_trotter_basis_change_matrices(self, *args: Any, **kwargs: Any) -> Any: ...
    def count_cnot_for_exponential(self, *args: Any, **kwargs: Any) -> Any: ...
    @staticmethod
    def givens_decomposition_square(*args: Any, **kwargs: Any) -> Any: ...
...
class SQOpPool:
    ...
    def set_orb_irreps(self, *args: Any, **kwargs: Any) -> Any: ...
    def excitation_irrep_allowed(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def get_count_pauli_terms_ex_deex(self, *args: Any, **kwargs: Any) -> Any: ...
    def count_cnot_for_jw_exponential(self, *args: Any, **kwargs: Any) -> Any: ...
    def count_cnot_for_term_jw_exponential(self, *args: Any, **kwargs: Any) -> Any: ...
    def fill_pool(self, pool_type: str) -> None: ...
    def fill_pool_kUpCCGSD(self, *args: Any, **kwargs: Any) -> Any: ...
    def fill_pool_kUpCCGSDx(self, *args: Any, **kwargs: Any) -> Any: ...
    def fill_pool_sq_hva(self, *args: Any, **kwargs: Any) -> Any: ...
    def fill_pool_df_trotter(self, *args: Any, **kwargs: Any) -> Any: ...
    def append_givens_ops_sector(self, *args: Any, **kwargs: Any) -> Any: ...
    def append_diagonal_ops_all(self, *args: Any, **kwargs: Any) -> Any: ...
    def add_connection_pairs(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_commutativity_graph(self, *args: Any, **kwargs: Any) -> Any: ...
    def reorder_terms_from_graph(self, *args: Any, **kwargs: Any) -> Any: ...
    def shuffle_terms_random(self, *args: Any, **kwargs: Any) -> Any: ...
    def str(self) -> str: ...
...
class SQOpPoolGPU:
    """Python binding for SQOpPoolGPU."""
    def __init__(self) -> None: ...
    ...
    def update_evolution_coeffs(self, *args: Any, **kwargs: Any) -> Any: ...
...
class Computer:
    ...
    def get_fci_comp_state_diff(self, *args: Any, **kwargs: Any) -> Any: ...
...
class FCIComputer:
    ...
    def zero_state(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def apply_tensor_spat_1bdy(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def apply_tensor_spat_12bdy_debug_elementwise(self, *args: Any, **kwargs: Any) -> Any: ...
    def apply_tensor_spat_012bdy_debug_elementwise(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def get_spin_squared_expectation(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_spin_squared(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_natural_orbital_occupation_numbers(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_noons(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_NOONs(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def evolve_op2_taylor(self, *args: Any, **kwargs: Any) -> Any: ...
    def evolve_tensor_taylor(self, *args: Any, **kwargs: Any) -> Any: ...
    def evolve_tensor2_taylor(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def evolve_pool_trotter_basic_not_inplace(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def evolve_pool_trotter_not_inplace(self, *args: Any, **kwargs: Any) -> Any: ...
    def apply_df_ham(self, *args: Any, **kwargs: Any) -> Any: ...
    def evolve_df_ham_trotter(self, *args: Any, **kwargs: Any) -> Any: ...
    def apply_two_determinant_rotations(self, *args: Any, **kwargs: Any) -> Any: ...
    def evolve_givens(self, *args: Any, **kwargs: Any) -> Any: ...
    def evolve_diagonal_from_mat(self, *args: Any, **kwargs: Any) -> Any: ...
    def set_state(self, state: Tensor) -> None: ...
    def get_state(self) -> Tensor: ...
    def get_state_deep(self) -> Tensor: ...
    def get_hf_dot(self) -> Complex: ...
    def get_nonzero_idxs(self, *args: Any, **kwargs: Any) -> Any: ...
...
class FCIGraph:
    ...
    def get_astr_at_idx(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_bstr_at_idx(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_aind_for_str(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_bind_for_str(self, *args: Any, **kwargs: Any) -> Any: ...
...
class Tensor:
    ...
    def read_data(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def copy_to_nparray(self, *args: Any, **kwargs: Any) -> Any: ...
...
class local_timer:
    ...
    def accumulate(self, *args: Any, **kwargs: Any) -> Any: ...
...
class TensorGPU:
    ...
    def gpu_only(self, *args: Any, **kwargs: Any) -> Any: ...
    def gpu_only_error(self, *args: Any, **kwargs: Any) -> Any: ...
    def on_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def data_type(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def zero(self) -> None: ...
    def set(self, indices: List[int], value: Complex) -> None: ...
    def copy_to_tensor(self, *args: Any, **kwargs: Any) -> Any: ...
    def fill_from_nparray(self, array: NDArray[np.complex128], shape: List[int]) -> None: ...
    def fill_from_tensor_cpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def vector_dot(self, *args: Any, **kwargs: Any) -> Any: ...
    def __repr__(self, *args: Any, **kwargs: Any) -> Any: ...
...
class FCIComputerGPU:
    ...
    def hartree_fock_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_hf_dot(self) -> Complex: ...
    def set_element(self, idx: int, value: Complex) -> None: ...
    def get_element(self, *args: Any, **kwargs: Any) -> Any: ...
    def on_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def to_gpu(self) -> None: ...
    def to_cpu(self) -> None: ...
    def gpu_error(self, *args: Any, **kwargs: Any) -> Any: ...
    def cpu_error(self, *args: Any, **kwargs: Any) -> Any: ...
    def copy_to_tensor_cpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_acc_timer(self) -> local_timer: ...
    def get_Na(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_Nb(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def apply_tensor_spin_12bdy(self, tensor: Tensor) -> None: ...
    def apply_tensor_spin_012bdy(self, tensor: Tensor) -> None: ...
    def apply_tensor_spat_12bdy_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def apply_tensor_spat_012bdy_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def apply_tensor_spat_12bdy_gpu_v2(self, *args: Any, **kwargs: Any) -> Any: ...
    def apply_tensor_spat_012bdy_gpu_v2(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def get_noons(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_NOONs(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_exp_val_tensor_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def evolve_op_taylor_cpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def apply_sqop_evolution_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def apply_sqop_evolution_from_pool_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def evolve_pool_trotter_basic_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def evolve_pool_trotter_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def state_vector_dot_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def dot_sqop_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def dot_sqop_gpu_real(self, *args: Any, **kwargs: Any) -> Any: ...
    def dot_sqop_from_pool_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def dot_sqop_from_pool_gpu_real(self, *args: Any, **kwargs: Any) -> Any: ...
    def set_state_from_other_cpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def set_state_from_other_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def set_state(self, state: Tensor) -> None: ...
    def get_state(self) -> Tensor: ...
    def get_state_deep(self) -> Tensor: ...
    def copy_state_into(self, *args: Any, **kwargs: Any) -> Any: ...
    def populate_index_arrays_for_pool_evo(self, *args: Any, **kwargs: Any) -> Any: ...
    def copy_to_tensor_thrust_gpu(self, *args: Any, **kwargs: Any) -> Any: ...
    def copy_to_tensor_thrust_cpu(self, *args: Any, **kwargs: Any) -> Any: ...
...
class FCIGraphGPU:
    """Python binding for FCIGraphGPU."""
    def __init__(self) -> None: ...
...
def set_gpu_only(*args: Any, **kwargs: Any) -> Any: ...
def get_gpu_only(*args: Any, **kwargs: Any) -> Any: ...
@overload
