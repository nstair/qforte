...
class TensorOperator:
    ...
    def str(self, print_data: bool = True, print_complex: bool = False, 
           maxcols: int = 5, data_format: str = "%12.7f", header_format: str = "%12zu") -> str: ...
    def __str__(self, print_data: bool = True, print_complex: bool = False, 
              maxcols: int = 5, data_format: str = "%12.7f", header_format: str = "%12zu") -> str: ...
    def __repr__(self, print_data: bool = True, print_complex: bool = False, 
               maxcols: int = 5, data_format: str = "%12.7f", header_format: str = "%12zu") -> str: ...
...
class SQOpPool:
    ...
    def get_qubit_operator(self, order_type: str, combine_like_terms: bool = True, 
                          qubit_excitations: bool = False) -> QubitOperator: ...
...
class FCIComputer:
    ...
    def apply_sqop_evolution(self, time: float, sqop: SQOperator, 
                           antiherm: bool = False, adjoint: bool = False) -> None: ...
    def evolve_pool_trotter_basic(self, sqop: SQOperator, 
                                antiherm: bool = False, adjoint: bool = False) -> None: ...
    def evolve_pool_trotter(self, sqop: SQOperator, evolution_time: float, 
                          trotter_steps: int, trotter_order: int,
                          antiherm: bool = False, adjoint: bool = False) -> None: ...
...
class Tensor:
    ...
    def gemm(self, B: Tensor, transa: str = 'N', transb: str = 'N', 
            alpha: Complex = 1.0, beta: Complex = 1.0, mult_B_on_right: bool = False) -> None: ...
    ...
    @staticmethod
    def einsum(Ainds: List[str], Binds: List[str], Cinds: List[str], 
              A: Tensor, B: Tensor, C3: Tensor, alpha: Complex = 1.0, beta: Complex = 0.0) -> None: ...
    
    @staticmethod
    def permute(Ainds: List[str], Cinds: List[str], A: Tensor, C2: Tensor, 
               alpha: Complex = 1.0, beta: Complex = 0.0) -> None: ...
...
# These would need to be defined based on the actual implementations in:
# qforte.abc, qforte.adapters, qforte.helper, etc.
